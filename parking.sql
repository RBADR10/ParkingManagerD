...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 17 jan. 2022 à 10:49
...
--
ALTER TABLE `section`
  ADD CONSTRAINT `fk` FOREIGN KEY (`idPlace`) REFERENCES `place` (`id`);

--
-- Contraintes pour la table `ticket`
--
ALTER TABLE `ticket`
  ADD CONSTRAINT `fk_1` FOREIGN KEY (`idSection`) REFERENCES `section` (`id`);
COMMIT;
